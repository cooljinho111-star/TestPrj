...
testDoc.h, testDoc.cpp - 문서
    이 파일에는 CtestDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CtestDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

testView.h, testView.cpp - 문서 뷰
    이 파일에는 CtestView 클래스가 들어 있습니다.
    CtestView 개체는 CtestDoc 개체를 보는 데 사용됩니다.

res\testDoc.ico
    CtestDoc 클래스의 MDI 자식 창에 대한 아이콘으로 사용되는
    아이콘 파일입니다. 이 아이콘은 주 리소스 파일인 test.rc에
    의해 포함됩니다.
